---
title: "CII 风险评分方法论"
description: "综合不稳定指数（CII）与战略风险汇总背后的编辑性方法论。文档化各国 baselineRisk、eventMultiplier、四分量评分（Unrest、Conflict、Security、Information）、战略风险分档推导，以及戳记在每个 CiiScore 上的 v7 公式版本。"
---
